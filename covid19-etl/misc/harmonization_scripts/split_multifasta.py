...
parser = argparse.ArgumentParser(
    description="Split a multi-fasta file into individual fasta files using the sequence ID as their file name."
)
parser.add_argument(
    "-f", "--multifasta", metavar="multifasta", help="Input multi-fasta file", type=str
)
