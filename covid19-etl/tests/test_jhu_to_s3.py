...
INPUT_DATA_DIR = os.path.join(os.path.dirname(__file__), "test_data/test_jhu_to_s3_input")
OUTPUT_DATA_DIR = os.path.join(os.path.dirname(__file__), "test_data/test_jhu_to_s3_output")
FILES_TO_DELETE = set()
