...
class GAGNON_LAB_STRAIN_DATA(base.BaseETL):
    def __init__(self, base_url, access_token, s3_bucket):
        ...
        self.expected_headers = ['countyFIPS','date','19A','19B','20A','20A.EU2','20B','20C','20D','20E (EU1)','20G','20H/501Y.V2','20I/501Y.V1','20J/501Y.V3']
        self.column_headers = {
            'countyFIPS': 0,
            'date': 1,
            '19A': 2,
    ...
    def parse_row(self, row):
        ...
        self.nested_dict[self.column_headers['countyFIPS']].append({
            'DE': getDiffDaysSinceDataEpoch(datetime.strptime(row[self.column_headers['date']],'%Y-%m-%d')),
    ...
    def publish_to_s3(self):
        ...
        self.s3_client.put_object(Body=str(json.dumps(self.nested_dict)), Bucket=self.s3_bucket, Key='gagnon_lab_strain_data.json')
        print("Done!")
